...
const About = () => {
  ...
  return (
    <div className="min-h-screen pt-20 bg-white dark:bg-club-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mb-12">
            <h3 className="text-2xl font-display mb-4 text-club-black dark:text-club-text flex items-center">
              <GraduationCap className="w-6 h-6 mr-3 text-club-neon" />
              {currentContent.future.title}
            </h3>
            <p className="text-lg text-club-smoke dark:text-club-text/70">
